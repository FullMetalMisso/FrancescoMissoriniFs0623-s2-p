        ...
        <Col key={i} className='text-dark'>
            <div>
                ...
                <div>
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-clouds-fill text-dark" viewBox="0 0 16 16">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-haze2-fill text-dark" viewBox="0 0 16 16">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-sun-fill text-dark" viewBox="0 0 16 16">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-drizzle-fill text-dark" viewBox="0 0 16 16">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-snow-fill text-dark" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-lightning-fill text-dark" viewBox="0 0 16 16">
